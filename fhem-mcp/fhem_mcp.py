...
# Comma-separated extra entries for the MCP SDK DNS rebinding protection
# (allowed Host headers / Origins), e.g. MCP_ALLOWED_HOSTS="192.168.178.10:5887,mcp.example.com:*"
